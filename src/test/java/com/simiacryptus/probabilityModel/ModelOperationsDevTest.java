...
import com.simiacryptus.probabilityModel.rules.KDTreeRuleGenerator;
import com.simiacryptus.probabilityModel.rules.MetricRule;
import com.simiacryptus.probabilityModel.rules.PartitionRule;
import com.simiacryptus.probabilityModel.rules.MetricRuleBoundary;
...
//      toPlot.add(new SampledDistribution(boundaryPoints));
    ...
    final Scatter chart = TestUtil.getScatterChart(this.plotSize, this.range, toPlot.toArray(new Distribution[] {}));
